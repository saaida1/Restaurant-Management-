...
var PayPalCardFieldsForm = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: className },
        React__default["default"].createElement(PayPalCardField, __assign({ fieldName: "NameField" }, options)),
        React__default["default"].createElement(PayPalCardField, __assign({ fieldName: "NumberField" }, options)),
        React__default["default"].createElement(FlexContainer, null,
            React__default["default"].createElement(FullWidthContainer, null,
                React__default["default"].createElement(PayPalCardField, __assign({ fieldName: "ExpiryField" }, options))),
            React__default["default"].createElement(FullWidthContainer, null,
                React__default["default"].createElement(PayPalCardField, __assign({ fieldName: "CVVField" }, options))))));
};
